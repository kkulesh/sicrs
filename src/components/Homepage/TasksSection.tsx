...
export function TasksSection() {
  ...
  return (
    <section id="about-us" className="scroll-mt-[60px] relative py-16 bg-primary1">  
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tasks.map((task, index) => (
            <Card key={index} className="border shadow-xl shadow-black/50 hover:shadow-2xl hover:shadow-black/70 transition-shadow duration-500 bg-white">
